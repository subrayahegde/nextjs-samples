...
export default function AirportDetailNew(props) {
const [airport, setairport] = useState('');

useEffect(() => {  
     console.log("props:" + props.code);
     const id = props.code;  
     const airport = airports.filter(airport => airport.abbreviation === id.toUpperCase())[0];
     setairport(airport);
});
...
return (
   <div class="container mx-auto grid grid-cols-9 mt-5 gap-5">
    <aside class="col-span-2">    
     <h2 class="text-2xl leading-7 font-semibold">This is the Child Page</h2>
